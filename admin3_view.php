...
<?php echo "Welcome Course Coordinator"; ?>
</font></td>
...
<tr align='center'>
	...
	<td> <?php if($SB_1==0) echo"Pending"; else echo"Accepted"; ?>
	<td> <?php if($SB_2==0) echo"Pending"; else echo"Accepted"; ?>
	<td> <?php if($SB_3==0) echo"Pending"; else echo"Accepted"; ?>
	<td> <?php if($SB_4==0) echo"Pending"; else echo"Accepted"; ?>
	<td><a href='admin3_approve.php?approve=<?php echo $u_id?>'> <input type="button" name="approve" value="Approve"> </a></td>
	<td><a href='admin3_approve.php?reject=<?php echo $u_id?>'> <input type="button" name="reject" value="Reject"> </a></td>
	</tr>
<?php } ?>
