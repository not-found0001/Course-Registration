...
<?php echo "Welcome Dept. Chairman"; ?>
</font></td>
...
<tr align='center'>
	...
	<td><a href='admin2_approve.php?approve2=<?php echo $u_id?>'> <input type="button" name="approve" value="Approve"> </a></td>
	<td><a href='admin2_approve.php?reject2=<?php echo $u_id?>'> <input type="button" name="reject" value="Reject"> </a></td>
	</tr>
<?php } ?>
