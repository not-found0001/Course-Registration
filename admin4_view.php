...
<?php echo "Welcome Exam Controller"; ?>
</font></td>
...
<tr align='center'>
	...
	<td><a href='admin4_approve.php?approve=<?php echo $u_id?>'> <input type="button" name="approve" value="Approve"> </a></td>
	<td><a href='admin4_approve.php?reject=<?php echo $u_id?>'> <input type="button" name="reject" value="Reject"> </a></td>
	</tr>
<?php } ?>
